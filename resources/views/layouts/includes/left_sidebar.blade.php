                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class=" mdi mdi-school"></i><span>
                                    Pédagogie</span> <i class="mdi mdi-chevron-right"></i></a>
                            <ul class="list-unstyled">
                                <!--sub-title-->
                                <li class="has_sub">
                                     <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-calendar-clock"></i><span>
                                    Assiduité</span> <i class="mdi mdi-chevron-right"></i></a>
                                    <ul class="list-unstyled">
                                        <li><a href="widgets-charts.html">Statistiques </a></li>
                                         ...
                                         <li><a href="widgets-charts.html">Feuille Présence Saisi</a></li>
                                         <li><a href="widgets-charts.html"> Rapports Assiduité</a></li>
                                         <li><a href="widgets-charts.html">Rapport Assiduité Groupes </a></li>
                                    </ul>
                                </li>
                                <!--end-sub-title-->
                                ...
                                <li class="has_sub">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><a href="widgets-charts.html">Paramètrage  </a></li>
                                         <li><a href="widgets-charts.html">Modèles (prog. annuels)</a></li>
                                         <li><a href="widgets-charts.html">Unités (modules) </a></li>
                                         <li><a href="widgets-charts.html">Dispensés  </a></li>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-chair-school"></i>
                                <span>Scolarité</span> <i class="mdi mdi-chevron-right"></i></a>
                            <ul class="list-unstyled">
                                <!--sub-title-->
                                 <li class="has_sub">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><a href="widgets-charts.html">Vue Générale   </a></li>
                                         <li><a href="widgets-charts.html">Stat. Détaillées </a></li>
                                ...
                                <!--end-sub-title-->
                                 ...
                                 <li class="has_sub">
                                    ...
                                    Paramètrage Scolarité </span> <i class="mdi mdi-chevron-right"></i></a>
                                    <ul class="list-unstyled">
                                        <li><a href="widgets-charts.html">Années Universitaires </a></li>
                                         <li><a href="widgets-charts.html">Remises Spéciales  </a></li>

                                         <li><a href="widgets-charts.html">Plan Scolarité</a></li>

                                         <li><a href="widgets-charts.html">Attestations</a></li>

                                         <li><a href="widgets-charts.html">Mois</a></li>

                                         <li><a href="widgets-charts.html">Liste Pièces</a></li>
                                ...
                                <!--end-sub-title-->
                                 ...
                                 <li class="has_sub">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><a href="widgets-charts.html">Liste Pré-inscriptions </a></li>
                                         <li><a href="widgets-charts.html">Liste étudiants(es)  </a></li>

                                         <li><a href="widgets-charts.html">Trombinoscopes</a></li>

                                         <li><a href="widgets-charts.html">Liste Non Réinscrits </a></li>

                                         <li><a href="widgets-charts.html">Liste Attestations </a></li>

                                         <li><a href="widgets-charts.html">Liste Départs</a></li>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="  mdi mdi-settings"></i> <span> Paramètrages
                                </span> <i class="mdi mdi-chevron-right"></i></a>
                            <ul class="list-unstyled">
