...
<!-- Mirrored from bonoroadmin.web.app/vertical-light/app-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Mar 2021 10:49:16 GMT -->
                          ...
                          <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            <li class="hide-phone">
                              ...
                              <li class="dropdown dropslide">
                                    <a class="nav-link" href="page-profile.html#" id="navbarDropdownProfile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img src="assets/images/profile.jpg" alt="user-img" class="rounded-circle img-thumbnail img-responsive">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                        <a class="dropdown-item" href="page-profile.html#"><i class="mdi mdi-account"></i> Profile</a>
                                        <a class="dropdown-item" href="page-profile.html#"><i class="mdi mdi-settings"></i> Settings</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="page-profile.html#"><i class="mdi mdi-power"></i> Logout</a>
                                    </div>
                                </li>
                          </ul>
                      </nav>
                            ...
                            <div class="col-sm-8">
                                <div class="bg-picture card-box">
                                    <div class="profile-info-name">
                                        ...
                                        <div class="profile-info-detail">
                                            <h4 class="m-0">Silina Afra</h4>
                                            <p class="text-muted m-b-20"><i>Graphic Designer</i></p>
                                            <p>Hi I'm Silina Afra, Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                ...
                                <form method="post" class="card-box">
                                    ...
                                    <div class="p-t-10 pull-right">
                                        <a class="btn btn-sm btn-info waves-effect waves-light">Send</a>
                                    </div>
                                    <ul class="nav nav-pills profile-pills m-t-10">
                                        <li>
                                            <a href="page-profile.html#"><i class="fa fa-user"></i></a>
                                        </li>
                                        <li>
                                            <a href="page-profile.html#"><i class="fa fa-location-arrow"></i></a>
                                        </li>
                                        <li>
                                            <a href="page-profile.html#"><i class=" fa fa-camera"></i></a>
                                        </li>
                                        <li>
                                            <a href="page-profile.html#"><i class="fa fa-smile-o"></i></a>
                                        </li>
                                    </ul>
                                ...
                                <div class="card-box">
                                    <div class="comment">
                                        ...
                                        <div class="comment-body">
                                            <div class="comment-text">
                                                <div class="comment-header">
                                                    <a href="page-profile.html#" title="">Titrit Abaknous</a><span>about 2 minuts ago</span>
                                                </div>
                                            ...
                                            <div class="comment-footer">
                                                <a href="page-profile.html#"><i class="fa fa-thumbs-o-up"></i></a>
                                                <a href="page-profile.html#"><i class="fa fa-thumbs-o-down"></i></a>
                                                <a href="page-profile.html#">Reply</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="comment">
                                            ...
                                            <div class="comment-body">
                                                <div class="comment-text">
                                                    <div class="comment-header">
                                                        <a href="page-profile.html#" title="">Sifaou Smita</a><span>about 1 hour ago</span>
                                                    </div>
                                                    Wow impressive!
                                                </div>
                                                <div class="comment-footer">
                                        ...
                                        <div class="comment">
                                            ...
                                            <div class="comment-body">
                                                <div class="comment-text">
                                                    <div class="comment-header">
                                                        <a href="page-profile.html#" title="">Tilila Moga</a><span>about 2 hours ago</span>
                                                    </div>
                                            ...
                                            <div class="comment">
                                                ...
                                                <div class="comment-body">
                                                    <div class="comment-text">
                                                        <div class="comment-header">
                                                            <a href="page-profile.html#" title="">Amayno Kilote</a><span>3 hours ago</span>
                                                        </div>
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="comment-body">
                                            <div class="comment-text">
                                                <div class="comment-header">
                                                    <a href="page-profile.html#" title="">Titrit Abaknous</a><span>about 4 hours ago</span>
                                                </div>
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="comment-body">
                                            <div class="comment-text">
                                                <div class="comment-header">
                                                    <a href="page-profile.html#" title="">Tazrzit Jolm</a><span>10 hours ago</span>
                                                </div>
                                    ...
                                    <div class="m-t-30 text-center">
                                        <a href="page-profile.html" class="btn btn-default waves-effect waves-light btn-sm">Load More...</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="card-box">
                                  <div class="dropdown pull-right">
                                      <a href="page-profile.html#" class="dropdown-toggle arrow-none card-drop" data-toggle="dropdown" aria-expanded="false">
                                  ...
                                  <ul class="list-group m-b-0 user-list">
                                      <li class="list-group-item">
                                          <a href="page-profile.html#" class="user-list-item">
                                              <div class="avatar">
                                                  <i class="mdi mdi-circle text-primary"></i>
                                              </div>
                                              <div class="user-desc">
                                                  <span class="name">Meet Manager</span>
                                                  <span class="desc">January 29, 2019 - 14:30am to 18:45pm</span>
                                              </div>
                                          </a>
                                      </li>
                                    ...
                                    <ul class="list-group m-b-0 user-list">
                                        <li class="list-group-item">
                                            <a href="page-profile.html#" class="user-list-item">
                                                ...
                                                <div class="user-desc">
                                                    <span class="name">Sifaou Smita</span>
                                        ...
                                        <li class="list-group-item">
                                            <a href="page-profile.html#" class="user-list-item">
                                                ...
                                                <div class="user-desc">
                                                    <span class="name">Tilila Moga</span>
                                        ...
                                        <li class="list-group-item">
                                            <a href="page-profile.html#" class="user-list-item">
                                                ...
                                                <div class="user-desc">
                                                    <span class="name">Tonarouz Miaou</span>
                                        ...
                                        <li class="list-group-item">
                                            <a href="page-profile.html#" class="user-list-item">
                                                ...
                                                <div class="user-desc">
                                                    <span class="name">Ayour Lebakour</span>
                                        ...
                                        <li class="list-group-item">
                                            <a href="page-profile.html#" class="user-list-item">
                                                ...
                                                <div class="user-desc">
                                                    <span class="name">Titrit Abaknous</span>
...
<!-- Mirrored from bonoroadmin.web.app/vertical-light/app-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Mar 2021 10:49:18 GMT -->
</html>
